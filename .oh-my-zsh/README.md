...
| Method    | Command                                                                                           |
| :-------- | :------------------------------------------------------------------------------------------------ |
| **curl**  | `sh -c "$(curl -fsSL https://raw.githubusercontent.REDACTED.sh)"` |
| **wget**  | `sh -c "$(wget -O- https://raw.githubusercontent.REDACTED.sh)"`   |
| **fetch** | `sh -c "$(fetch -o - https://raw.githubusercontent.REDACTED.sh)"` |
...
```sh
wget https://raw.githubusercontent.REDACTED.sh
sh install.sh
```
...
```sh
sh -c "$(curl -fsSL https://raw.githubusercontent.REDACTED.sh)" "" --unattended
```
...
- `REMOTE` (default: `https://github.com/${REPO}.git`): this is the full URL of the git repository
  ...
  Bitbucket...) or if you want to clone with SSH instead of HTTPS (`private:user/project.git`).
