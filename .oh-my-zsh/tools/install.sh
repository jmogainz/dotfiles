...
#   sh -c "$(curl -fsSL https://raw.githubusercontent.REDACTED.sh)"
# or via wget:
#   sh -c "$(wget -qO- https://raw.githubusercontent.REDACTED.sh)"
# or via fetch:
#   sh -c "$(fetch -o - https://raw.githubusercontent.REDACTED.sh)"
#
