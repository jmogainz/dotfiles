...
for file (
  ...
  /REDACTED-command-not-found/handler.sh
  /REDACTED-command-not-found/handler.sh
  /home/linuxbrew/.REDACTED-command-not-found/handler.sh
); do
  if [[ -r "$file" ]]; then
    source "$file"
    unset file
...
# Fedora: https://fedoraproject.REDACTED
...
# NixOS: https://github.REDACTED-not-found
